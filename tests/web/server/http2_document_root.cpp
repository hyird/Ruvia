...
int main() {
    ...
    asio::co_spawn(
        ...
        [&]() -> asio::awaitable<void> {
            ...
            co_await taskAsAwaitable(runHttp2SansIoSession(sock, routes, worker, fixture.context(fixture.services(workerHandle).withPlainTransport("127.0.0.1").withPrecompressedStaticFiles())));
        },
        asio::detached);
