...
static_assert(std::same_as<decltype(ruvia::tryRunBlocking(std::declval<ruvia::BlockingPool&>(), std::declval<ruvia::WorkerHandle>(), std::declval<ruvia::StopToken>(), std::declval<int (*)()>())), BlockingIntTask>);
static_assert(std::same_as<decltype(ruvia::tryRunBlocking(std::declval<ruvia::BlockingPool&>(), std::declval<ruvia::WorkerHandle>(), std::chrono::seconds(1), std::declval<ruvia::StopToken>(), std::declval<void (*)()>())), BlockingVoidTask>);
static_assert(std::same_as<decltype(ruvia::runBlocking(std::declval<ruvia::BlockingPool&>(), std::declval<ruvia::WorkerHandle>(), std::declval<ruvia::StopToken>(), std::declval<int (*)()>())), ruvia::Task<int>>);
static_assert(std::same_as<decltype(ruvia::runBlocking(std::declval<ruvia::BlockingPool&>(), std::declval<ruvia::WorkerHandle>(), std::chrono::seconds(1), std::declval<ruvia::StopToken>(), std::declval<void (*)()>())), ruvia::Task<void>>);
