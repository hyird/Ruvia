...
inline ruvia::ScopedOperation<std::string_view> makeExpiredContextTextRead() {
    ...
    auto context = ruvia::detail::ContextAccess::make(memory, request, ruvia::detail::ContextServices(nullptr, nullptr, nullptr, 1024));
...
inline ContextBodyReadObservation readContextGzipBody(std::string_view encoded, std::size_t maxDecodedBodyBytes) {
    ...
    auto context = ruvia::detail::ContextAccess::make(memory, request, ruvia::detail::ContextServices(nullptr, nullptr, nullptr, maxDecodedBodyBytes));
