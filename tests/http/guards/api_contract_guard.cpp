...
static_assert(std::same_as<decltype(std::declval<const ruvia::Http2Event&>().serverExpectationPlan(ruvia::HttpUnsupportedExpectationPolicy::kReject)), std::optional<ruvia::HttpServerExpectationPlan>>);
