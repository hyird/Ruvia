...
// while the context is destroyed deadlocks after a few rapid create/destroy cycles on
// MinGW/UCRT -- a long-standing, still-unfixed asio bug (chriskohlhoff/asio #424,
// #520). Because every socket test builds and tears down its own io_context, that
