...
void Http2WebSocketConnection<Session>::completeBackgroundWrite() noexcept {
...
template <typename Session>
bool Http2WebSocketConnection<Session>::heartbeatTick(std::int64_t now) noexcept {
...
template <typename Session>
Task<void> Http2WebSocketConnection<Session>::writeHeartbeatPing() {
    try {
