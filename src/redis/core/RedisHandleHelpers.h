...
[[nodiscard]] std::pmr::vector<std::pmr::string> redisCommandWithKeys(
...
[[nodiscard]] std::pmr::vector<std::pmr::string> redisHsetFieldsArgs(
    ...
    std::pmr::memory_resource* resource);
[[nodiscard]] std::pmr::vector<std::pmr::string> redisCommandWithKeyFields(
    std::string_view command,
    std::string_view key,
...
[[nodiscard]] std::pmr::vector<std::pmr::string> redisEvalArgs(
    std::string_view command,
    std::string_view script,
    std::span<const std::string_view> keys,
    std::span<const std::string_view> argv,
    std::pmr::memory_resource* resource);
[[nodiscard]] std::pmr::vector<std::pmr::string> redisBlockingPopArgs(
    std::string_view command,
    std::span<const std::string_view> keys,
