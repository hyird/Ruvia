...
| `ruvia_example_models_validation` | `web/models_validation.cpp` | Separate request/response models, JSON/form bodies, nested models, arrays, recursive lists, defaults, validation middleware and rules, non-throwing `jsonIf`/`formIf` fallbacks. |
