...
| `ruvia_example_api_surface` | `api_surface.cpp` | Hono-like C++ context/request/response facades, route metadata, decoded paths, Accept checks, buffered multipart, explicit body discard, response cookies, manual `HttpResponse` body ownership and PUT/PATCH streaming. |
