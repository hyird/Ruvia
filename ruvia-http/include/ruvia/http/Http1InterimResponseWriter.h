...
private:
    ...
    explicit constexpr Http1InterimResponseBufferTooSmall(std::size_t requiredHeadBytes) noexcept
...
public:
    ...
    [[nodiscard]] constexpr const Http1InterimResponsePrepareFailure* failure() const& noexcept {
