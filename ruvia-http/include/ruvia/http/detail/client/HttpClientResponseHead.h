...
using Http1ClientStatusLineParseResult = std::variant<
    Http1ClientParsedStatusLine,
    Http1ClientResponseParseError>;
using Http1ClientResponseHeadParseResult = std::variant<
    Http1ClientParsedResponseHead,
    Http1ClientResponseParseError>;
using Http1ClientResponsePlanningResult = std::variant<
