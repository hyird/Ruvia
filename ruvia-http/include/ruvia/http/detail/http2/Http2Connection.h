...
public:
    ...
    // accepts the complete RFC 3986 scheme grammar, including non-HTTP schemes.
    ...
    // accept any RFC 3986 scheme; WebSocket requires an HTTP(S) scheme. WebSocket
    // protocol names are matched case-insensitively and encoded as `websocket`.
