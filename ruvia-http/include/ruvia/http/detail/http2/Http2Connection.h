...
public:
    ...
    // schemes use the complete RFC 3986 authority grammar. Asterisk-form OPTIONS
    // requires std::nullopt.
    ...
    // accept any RFC 3986 scheme and require an origin-form path; WebSocket requires
    // an HTTP(S) scheme. WebSocket protocol names are matched case-insensitively and
    // encoded as `websocket`.
