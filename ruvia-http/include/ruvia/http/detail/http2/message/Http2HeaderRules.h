...
[[nodiscard]] inline bool http2IsForbiddenRequestTrailerHeader(std::string_view name) noexcept {
    ...
    switch (name.size()) {
        ...
        case 13:
            return name == "cache-control" || name == "accept-ranges" || name == "content-range";
        case 18:
