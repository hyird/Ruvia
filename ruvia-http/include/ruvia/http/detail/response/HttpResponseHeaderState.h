...
struct HttpResponseHeaderStateAccess final {
    ...
    [[nodiscard]] static HttpResponseHeader& upsertSetCookieUninitializedValue(HttpResponse& response, std::string_view wirePrefix, std::string_view cookieName, std::string_view path, std::string_view domain, std::size_t valueSize) {
...
[[nodiscard]] inline HttpResponseHeader& upsertResponseSetCookieUninitializedValue(HttpResponse& response, std::string_view wirePrefix, std::string_view cookieName, std::string_view path, std::string_view domain, std::size_t valueSize) {
