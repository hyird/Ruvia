...
struct HttpResponseFileAccess final {
    ...
    static void setBorrowedFile(
        HttpResponse& response, const std::filesystem::path& file, std::uint64_t size) {
        response.setBorrowedFileBody(file, size);
    }

    static void setBorrowedNativeFile(
        HttpResponse& response, const HttpNativePathChar* file, std::uint64_t size) {
        response.setBorrowedNativeFileBody(file, size);
    }

    static void setBorrowedFile(HttpResponse& response, const std::filesystem::path& file,
        std::uint64_t size, std::uint64_t offset, std::uint64_t length) {
        response.setBorrowedFileBody(file, size, offset, length);
    }

    static void setBorrowedNativeFile(HttpResponse& response, const HttpNativePathChar* file,
        std::uint64_t size, std::uint64_t offset, std::uint64_t length) {
...
inline void setResponseFileBody(
    HttpResponse& response, std::filesystem::path file, std::uint64_t size) {
...
inline void setResponseBorrowedFileBody(HttpResponse& response, const std::filesystem::path& file,
    std::uint64_t size, std::uint64_t offset, std::uint64_t length) {
...
inline void setResponseBorrowedNativeFileBody(HttpResponse& response,
    const HttpNativePathChar* file, std::uint64_t size, std::uint64_t offset,
    std::uint64_t length) {
