            ...
            switch (first) {
                case 'd':
                    if (httpAsciiEqualsIgnoreCase(name, "Date")) {
                        return kResponseHeaderDate;
                    }
                    break;
                case 'e':
                    if (httpAsciiEqualsIgnoreCase(name, "ETag")) {
                        return kResponseHeaderEtag;
                    }
                    break;
                case 'v':
                    if (httpAsciiEqualsIgnoreCase(name, "Vary")) {
                        return kResponseHeaderVary;
                    }
                    break;
                default:
                    break;
