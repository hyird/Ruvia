...
public:
    enum class Code : std::uint8_t { kNotConfigured, kConnectFailed, kAuthFailed, kProtocolError, kCommandError, kIoError, kTimeout, kCancelled, kClosing, kTransactionAborted };
