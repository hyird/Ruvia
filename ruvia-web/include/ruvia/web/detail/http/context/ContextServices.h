...
public:
    ...
    [[nodiscard]] ContextServices withPlainTransport(std::string_view remoteAddress, ListenerId listener = ListenerId{0}) const noexcept {
        auto services = *this;
    ...
    [[nodiscard]] ContextServices withTlsTransport(std::string_view remoteAddress, std::string_view clientCertificateSubject = {}, ListenerId listener = ListenerId{0}) const noexcept {
        auto services = *this;
