...
[[nodiscard]] inline Http1ServerConnectionPlan requireHttp1FinalResponseCommit(
    HttpResponse& response, Http1ServerConnectionPlan connectionPlan) {
...
[[nodiscard]] inline Http1ServerConnectionPlan finalizeBufferedRouteResponse(HttpResponse& response,
...
[[nodiscard]] inline Http1ServerConnectionPlan finalizeBodyRouteResponse(HttpResponse& response,
    Http1ServerConnectionPlan connectionPlan, Http1RequestSequence& requestSequence,
