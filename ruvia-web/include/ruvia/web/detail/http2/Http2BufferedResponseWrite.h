...
private:
    ...
    explicit constexpr Http2BufferedResponseWriteCompleted(HttpStatusCode status) noexcept
        : status_(status) {}
...
private:
    ...
    explicit constexpr Http2BufferedResponseWriteFailedAfterCommit(HttpStatusCode status) noexcept
        : status_(status) {}
...
public:
    ...
    [[nodiscard]] constexpr std::optional<HttpStatusCode> committedStatus() const noexcept {
...
private:
    ...
    union Value {
        constexpr explicit Value(Http2BufferedResponseWriteCompleted value) noexcept
            : completed(value) {}
        constexpr explicit Value(Http2BufferedResponseWritePeerAbortedBeforeCommit value) noexcept
            : peerAbortedBeforeCommit(value) {}
        constexpr explicit Value(Http2BufferedResponseWritePeerAbortedAfterCommit value) noexcept
            : peerAbortedAfterCommit(value) {}
        constexpr explicit Value(Http2BufferedResponseWriteFailedBeforeCommit value) noexcept
            : failedBeforeCommit(value) {}
        constexpr explicit Value(Http2BufferedResponseWriteFailedAfterCommit value) noexcept
