...
// The server transport configuration and its per-request access-log record. These
// are Context-agnostic value types the server sessions (h1/h2/ws) are parameterized
// by, so they live in ruvia-http and can be consumed without ruvia-web/App.h. App
// re-exports them (App.h includes this header).
