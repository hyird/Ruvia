...
constexpr unsigned char kAlpnProtocols[] = {2, 'h', '2', 8, 'h', 't', 't', 'p', '/', '1', '.', '1'};

extern "C" inline int edgeAlpnSelect(SSL* /*ssl*/, const unsigned char** out, unsigned char* outlen, const unsigned char* in, unsigned int inlen, void* /*arg*/) {
    if (SSL_select_next_proto(const_cast<unsigned char**>(out), outlen, kAlpnProtocols, sizeof(kAlpnProtocols), in, inlen) != OPENSSL_NPN_NEGOTIATED) {
