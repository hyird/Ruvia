...
std::string buildStatusWire(std::uint16_t status, HttpProtocolVersion protocolVersion) {
...
std::string chunkFrame(std::string_view chunk) {
    std::string out;
